...
# class ProxyListView(ProxyBaseView, ListView):

#     template_name = 'proxy/list.html'
#     context_object_name = 'films-obf'
#     paginate_by = 1

#     def get_context_data(self, **kwargs):
#         context = super(ProxyListView, self).get_context_data(**kwargs)
#         proxy = self.get_queryset()
